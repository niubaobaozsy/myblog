...
<div class="col-md-8">
  <form action="/blog/admin.php?c=content&a=index" method="get">
    <div class="row">
    <div class="col-md-4">
...
<table class="table table-bordered table-striped">
   ...
   <tbody>
    <?php if(is_array($note)): $i = 0; $__LIST__ = $note;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$note): $mod = ($i % 2 );++$i;?><tr>
      ...
      <td><a href="#" id="note_edit" name="<?php echo ($note["note"]["id"]); ?>">修改</a></td>
      <td><a href="#">删除</a></td> 
...
<script>
  var SCOPE={
     'add_url' : '/blog/admin.php?c=admin&a=add',//展示添加页面url
    'edit_url' : '/blog/admin.php?c='
  };
